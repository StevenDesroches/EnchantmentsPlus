...
public enum Tool {
    ...
    CROSSBOW("Crossbow", new Material[]{Material.CROSSBOW}, true),
    ...
    ALL("All", new Material[]{WOODEN_AXE, STONE_AXE, GOLDEN_AXE, IRON_AXE, DIAMOND_AXE, NETHERITE_AXE, WOODEN_SHOVEL, STONE_SHOVEL, GOLDEN_SHOVEL,
            ...
            STONE_PICKAXE, GOLDEN_PICKAXE, IRON_PICKAXE, DIAMOND_PICKAXE, NETHERITE_PICKAXE, FISHING_ROD, SHEARS, Material.BOW, Material.CROSSBOW, FLINT_AND_STEEL,
